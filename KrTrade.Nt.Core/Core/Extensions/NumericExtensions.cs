...
namespace KrTrade.Nt.Core.Core
{
    ...
    public static class NumericExtensions
    {
        ...
        private static string ToString(this double value, FormatLength formatLength)
        {
            switch (formatLength)
            {
        ...
        /// <returns>The string with the format length indicated.</returns>
        /// <exception cref="NotImplementedException">The type of the <see cref="FormatLength"/> is not implemented yet.</exception>
        private static string ToString(this float value, FormatLength formatLength)
        {
            switch (formatLength)
            {
                case FormatLength.Long:
        ...
        /// <returns>The string with the format length indicated.</returns>
        /// <exception cref="NotImplementedException">The type of the <see cref="FormatLength"/> is not implemented yet.</exception>
        private static string ToString(this decimal value, FormatLength formatLength)
        {
            switch (formatLength)
            {
                case FormatLength.Long:
        ...
        /// <returns>The string with the format length indicated.</returns>
        /// <exception cref="NotImplementedException">The type of the <see cref="FormatLength"/> is not implemented yet.</exception>
        private static string ToString(this int value, FormatLength formatLength)
        {
            switch (formatLength)
            {
                case FormatLength.Long:
        ...
        /// <returns>The string with the format length indicated.</returns>
        /// <exception cref="NotImplementedException">The type of the <see cref="FormatLength"/> is not implemented yet.</exception>
        private static string ToString(this long value, FormatLength formatLength)
        {
            switch (formatLength)
            {
                case FormatLength.Long:
