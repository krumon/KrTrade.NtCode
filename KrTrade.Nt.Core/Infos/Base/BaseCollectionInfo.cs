...
{
    public abstract class BaseCollectionInfo<TElementInfo,TElementType,TCollectionType> : BaseInfo<TCollectionType>, ICollectionInfo<TElementInfo,TElementType,TCollectionType>
        ...
        where TCollectionType : Enum
    {
        ...
        protected override string ToUniqueString()
        {
            ...
            return string.IsNullOrEmpty(key) ? $"AUTO_KEY({Guid.NewGuid()})" : key;
        }
