...
namespace KrTrade.Nt.Core.TradingHours
{
    ...
    /// <summary>
    /// <see cref="TradingHoursType"/> helper methods.
    /// </summary>
    public static class TradingHoursTypeExtensions
    {

        /// <summary>
        /// Converts the <see cref="TradingHoursType"/> to unique code.
        /// </summary>
        ...
        /// <returns>The name of the <see cref="TradingHoursType"/>.</returns>
