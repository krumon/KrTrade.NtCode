...
namespace KrTrade.Nt.Core.TradingHours
{
        ...
        IEquatable<TradingTime>
    {
        ...
        /// The trading time type.
        /// </summary>
        public TradingHoursType TradingTimeType 
        {
            private set 
            { 
        ...
        public TradingTime(TimeSpan time, TimeZoneInfo timeZoneInfo)
        {
            ...
            TradingTimeType = TradingHoursType.Custom;
        }
        ...
        /// <summary>
        /// Create a default instance of <see cref="Core.TradingTime"/> by specific <see cref="KrTrade.Nt.DI.TradingTimeKind"/>.
        /// </summary>
