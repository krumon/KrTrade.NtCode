...
namespace KrTrade.Nt.Core
{
    ...
    public abstract class BaseElement<TInfo> : BaseElement, IElement<TInfo>
        where TInfo : IInfo
    {
        protected BaseElement(NinjaScriptBase ninjascript, TInfo info) : base(ninjascript, info)
        {
        }
        ...
        where TOptions : IOptions
    {
        ...
        protected BaseElement(NinjaScriptBase ninjascript, TInfo info, TOptions options) : base(ninjascript, info)
        {
            if (options == null)
