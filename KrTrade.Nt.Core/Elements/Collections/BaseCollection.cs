...
{
    public abstract class BaseCollection<TElement,TInfo> : BaseElement<TInfo>, ICollection<TElement,TInfo>, IEnumerable, IEnumerable<TElement>
        ...
        where TInfo : IInfo
    {
        ...
        public BaseCollection(NinjaScriptBase ninjascript, IInfo collectionInfo) : base(ninjascript,collectionInfo)
        { 
