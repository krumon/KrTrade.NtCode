...
namespace KrTrade.Nt.DI.DependencyInjection
{
    ...
    public static class ServiceProviderServiceExtensions
    {
        ...
        public static object GetRequiredService(this IServiceProvider provider, Type serviceType)
        {
            ...
            if (service == null)
            {
                throw new InvalidOperationException($"NoServiceRegistered, {serviceType}.");
            }
    ...
    /// Extension methods for getting services from an <see cref="IServiceProvider" />.
    /// </summary>
    public static class ServiceProviderServiceExtensions_Obsolete
    {
        /// <summary>
        /// Get service of type <typeparamref name="T"/> from the <see cref="IServiceProvider"/>.
        /// </summary>
        ...
        /// <param name="provider">The <see cref="IServiceProvider"/> to retrieve the service object from.</param>
        /// <returns>A service object of type <typeparamref name="T"/> or null if there is no such service.</returns>
        public static T GetService_Obsolete<T>(this IServiceProvider provider)
        {
            if (provider == null)
            {
                throw new ArgumentNullException(nameof(provider));
        ...
        public static object GetRequiredService_Obsolete(this IServiceProvider provider, Type serviceType)
        {
            if (provider == null)
            {
                throw new ArgumentNullException(nameof(provider));
        ...
        public static T GetRequiredService_Obsolete<T>(this IServiceProvider provider) // where T : notnull
        {
            if (provider == null)
            {
                throw new ArgumentNullException(nameof(provider));
            ...
            return (T)provider.GetRequiredService_Obsolete(typeof(T));
        }
        ...
        /// <param name="provider">The <see cref="IServiceProvider"/> to retrieve the services from.</param>
        /// <returns>An enumeration of services of type <typeparamref name="T"/>.</returns>
        public static IEnumerable<T> GetServices_Obsolete<T>(this IServiceProvider provider)
        {
            if (provider == null)
            {
                throw new ArgumentNullException(nameof(provider));
            ...
            return provider.GetRequiredService_Obsolete<IEnumerable<T>>();
        }
        ...
        /// <param name="serviceType">An object that specifies the type of service object to get.</param>
        /// <returns>An enumeration of services of type <paramref name="serviceType"/>.</returns>
        public static IEnumerable<object> GetServices_Obsolete(this IServiceProvider provider, Type serviceType)
        {
            if (provider == null)
            {
                throw new ArgumentNullException(nameof(provider));
            ...
            Type genericEnumerable = typeof(IEnumerable<>).MakeGenericType(serviceType);
            return (IEnumerable<object>)provider.GetRequiredService_Obsolete(genericEnumerable);
        }
    }
}
