...
namespace KrTrade.Nt.Console
{
    public class SessionDescriptor : IServiceDescriptor
    {
        ...
        /// <summary>
        /// Create a new custom instance of <see cref="SessionDescriptor"/> objects with specific <see cref="TradingHoursType"/> types and <paramref name="description"/>.
        /// </summary>
        /// <param name="beginSessionTimeType">The initial <see cref="TradingHoursType"/> type of the <see cref="SessionDescriptor"/> object.</param>
        /// <param name="endSessionTimeType">The final <see cref="TradingHoursType"/> type of the <see cref="SessionDescriptor"/> object.</param>
        ...
        public static SessionDescriptor CreateCustomTradingSession(InstrumentCode instrumentKey, TradingHoursType beginSessionTimeType, TradingHoursType endSessionTimeType, string description = "")
        {
            return new SessionDescriptor
            {
        ...
        public static SessionDescriptor CreateCustomTradingSession(InstrumentCode instrumentKey, TradingTime beginTradingTime, TradingHoursType endTradingTimeType, string description = "")
        {
            return new SessionDescriptor
            {
        ...
        /// <summary>
        /// Create a new custom instance of <see cref="SessionDescriptor"/> objects with specific <see cref="TradingTime"/> object, <see cref="TradingHoursType"/> type and <paramref name="description"/>.
        /// </summary>
        /// <param name="beginTradingTimeType">The initial <see cref="TradingHoursType"/> type of the <see cref="SessionDescriptor"/> object.</param>
        /// <param name="endTradingTime">The final <see cref="TradingTime"/> of the <see cref="SessionDescriptor"/> object.</param>
        /// <param name="description">Custom session hours description.</param>
        /// <returns>A new custom instance of <see cref="TradingSession"/> object.</returns>
        public static SessionDescriptor CreateCustomTradingSession(InstrumentCode instrumentKey, TradingHoursType beginTradingTimeType, TradingTime endTradingTime, string description = "")
        {
            return new SessionDescriptor
            {
        ...
        /// <summary>
        /// Create a new custom instance of <see cref="SessionDescriptor"/> objects with specific <see cref="TradingHoursType"/>, <see cref="TradingTime"/> properties and <paramref name="description"/>.
        /// </summary>
        ...
        /// <param name="endTradingTimeType">The final <see cref="TradingHoursType"/> type of the <see cref="SessionDescriptor"/> object.</param>
        /// <param name="description">Custom session hours description.</param>
        /// <returns>A new custom instance of <see cref="SessionDescriptor"/> object.</returns>
        public static SessionDescriptor CreateCustomTradingSession(InstrumentCode instrumentKey, TimeSpan beginTime, TimeZoneInfo beginTimeZoneInfo, TradingHoursType endTradingTimeType, string description = "")
        {
            return new SessionDescriptor
            {
        ...
        /// <returns>A new custom instance of <see cref="SessionDescriptor"/> object.</returns>
        public static SessionDescriptor CreateCustomTradingSession(InstrumentCode instrumentKey, TradingHoursType beginTradingTimeType, TimeSpan endTime, TimeZoneInfo endTimeZoneInfo, string description = "")
        {
            return new SessionDescriptor
            {
                _beginTradingTime = TradingTime.CreateSessionTimeByType(beginTradingTimeType, instrumentKey),
