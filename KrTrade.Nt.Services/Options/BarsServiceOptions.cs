...
namespace KrTrade.Nt.Services
{
    ...
    /// </summary>
    public class BarsServiceOptions : ServiceOptions, IBarsServiceOptions //: PrimaryBarsServiceOptions
    {

        /// <summary>
        /// Gets or sets the bars cache capacity.
        /// </summary>
        public int CacheCapacity { get; set; } = Globals.SERIES_DEFAULT_CAPACITY;

        /// <summary>
        /// Gets or sets the bars removed cache capacity.
        /// </summary>
        public int RemovedCacheCapacity { get; set; } = Globals.SERIES_DEFAULT_OLD_VALUES_CAPACITY;
