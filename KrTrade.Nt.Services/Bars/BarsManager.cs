...
namespace KrTrade.Nt.Services
{
    public class BarsManager : BaseService<BarsManagerInfo, BarsManagerOptions>, IBarsManager
    {
        ...
        //public double Open => _barsServiceCollection[0].Open;
        //public double High => _barsServiceCollection[0].High;
        //public double Low => _barsServiceCollection[0].Low;
        //public double Close => _barsServiceCollection[0].Close;
        //public double Volume => _barsServiceCollection[0].Volume;
        //public long Tick => _barsServiceCollection[0].Tick;

        //public int[] CurrentBars => _barsServiceCollection.CurrentBars;
        //public DateTime[] Times => _barsServiceCollection.Times;
        //public double[] Opens => _barsServiceCollection.Opens;
        //public double[] Highs => _barsServiceCollection.Highs;
        //public double[] Lows => _barsServiceCollection.Lows;
        //public double[] Closes => _barsServiceCollection.Closes;
        //public double[] Volumes => _barsServiceCollection.Volumes;
        //public long[] Ticks => _barsServiceCollection.Ticks;
        ...
        public Bar[] GetRange(int barsAgo, int period) => _barsServiceCollection[0].GetRange(barsAgo, period);
