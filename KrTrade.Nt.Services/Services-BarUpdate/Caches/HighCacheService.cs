...
namespace KrTrade.Nt.Services
{
    ...
    public class HighCacheService : SeriesCacheService
    {
        ...
        /// </summary>
        /// <param name="barsService">The <see cref="IBarsService"/> necesary for the <see cref="HighCacheService"/>.</param>
        ...
        /// <param name="displacement">The <see cref="HighCacheService"/> displacement respect the bars collection.</param>
        /// <exception cref="ArgumentNullException">The <see cref="IBarsService"/> cannot be null.</exception>
