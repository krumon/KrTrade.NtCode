...
//{
//    public abstract class IndicatorSeries : BaseNumericSeries, IIndicatorSeries
//    {
...
//        protected IndicatorSeries(IBarsService bars, PeriodSeriesInfo info) : base(bars,info)
//        {
//        }
...
//                if (Count == 0)
//                    return AddFirstValue(_candidateValue);
...
//                            if (IsValidValueToAdd(lastValue, candidateValue))
//                            {
...
//            Add();
//        }
//        protected override bool AddFirstValue(double candidateValue)
//        {
