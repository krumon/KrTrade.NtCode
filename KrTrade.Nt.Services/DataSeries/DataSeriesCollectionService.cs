...
namespace KrTrade.Nt.Services
{
    ...
    { 
        ...
        //public override string Name => nameof(MultiBarsService);

        //public override void Calculate()
        //{
        //    for (int i = 0; i < _barsServices.Count; i++)
        //        _barsServices[i].BarUpdate();
        //}
        ...
        //    for (int i = 0; i < _barsServices.Count; i++)
        //        _barsServices[i].OnConfigure();

        //    isConfigured = true;
        //}

        //protected override void DataLoaded(out bool isConfigureWhenDataLoaded)
        //{
        //    for (int i = 0; i < _barsServices.Count; i++)
        //        _barsServices[i].OnConfigure();
        ...
        //protected override bool Filters() => _barsServices != null && _barsServices.Count > 0;
        //public override void Log() => _barsServices[Ninjascript.BarsInProgress].Log();
        ...
        //{
        //    _barsServices[Ninjascript.BarsInProgress].Log();
        //}
