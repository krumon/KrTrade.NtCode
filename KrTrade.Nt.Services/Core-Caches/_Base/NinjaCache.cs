...
namespace KrTrade.Nt.Services
{
    public abstract class NinjaCache<TElement,TInput> : Cache<TElement>, INinjaCache<TElement,TInput>
    {
        ...
        protected NinjaCache(TInput input, int capacity = DEFAULT_CAPACITY, int oldValuesCapacity = DEFAULT_OLD_VALUES_CAPACITY, int barsIndex = 0) : base(capacity,oldValuesCapacity)
        {
