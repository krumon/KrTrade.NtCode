...
namespace KrTrade.Nt.Services
{
    public abstract class DoubleCache<TInput> : ValueCache<double,TInput>, INumericCache<double,TInput>
    {
        ...
        protected DoubleCache(TInput input, int capacity = DEFAULT_CAPACITY, int lengthOfRemovedCache = DEFAULT_LENGTH_REMOVED_CACHE, int barsIndex = 0) : base(input, capacity, lengthOfRemovedCache, barsIndex)
        {
        }
