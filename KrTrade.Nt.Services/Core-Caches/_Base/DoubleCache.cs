...
namespace KrTrade.Nt.Services
{
    public abstract class DoubleCache<TInput> : ValueCache<double,TInput>, INumericCache<double,TInput>
    {
        ...
        protected DoubleCache(TInput input, int capacity = DEFAULT_CAPACITY, int oldValuesCapacity = DEFAULT_OLD_VALUES_CAPACITY, int barsIndex = 0) : base(input, capacity, oldValuesCapacity, barsIndex)
        {
        }
