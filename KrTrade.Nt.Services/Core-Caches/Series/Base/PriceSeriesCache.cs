...
namespace KrTrade.Nt.Services
{
    public abstract class PriceSeriesCache : BaseSeriesCache
    {
        ...
        public PriceSeriesCache(ISeries<double> series) : base(series, DEFAULT_CAPACITY, 0, false) { }
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="series"/> cannot be null.</exception>
        public PriceSeriesCache(ISeries<double> series, int capacity) : base(series, capacity, 0, false) { }
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="series"/> cannot be null.</exception>
        public PriceSeriesCache(ISeries<double> series, int capacity, int displacement) : base(series, capacity, displacement, false) { }
        ...
        public PriceSeriesCache(NinjaScriptBase ninjascript) : base(ninjascript, DEFAULT_CAPACITY, 0, false, 0) { }
        ...
        /// <param name="capacity">The <see cref="Core.Caches.ICache{T}"/> capacity.</param>
        /// <exception cref="ArgumentNullException">The <paramref name="ninjascript"/> cannot be null.</exception>
        public PriceSeriesCache(NinjaScriptBase ninjascript, int capacity) : base(ninjascript, capacity, 0, false, 0) { }
        ...
        /// <param name="displacement">The displacement of <see cref="Core.Caches.ICache{T}"/> respect NinjaScript <see cref="ISeries{double}"/> used to gets elements.</param>
        /// <exception cref="ArgumentNullException">The <paramref name="ninjascript"/> cannot be null.</exception>
        public PriceSeriesCache(NinjaScriptBase ninjascript, int capacity, int displacement) : base(ninjascript, capacity, displacement, false, 0) { }
        ...
        public PriceSeriesCache(NinjaScriptBase ninjascript, int capacity, int displacement, int seriesIdx) : base(ninjascript, capacity, displacement, false, seriesIdx) { }
