...
namespace KrTrade.Nt.Services
{
    public abstract class CalculateSeriesCache : BaseSeriesCache
    {
        ...
        public CalculateSeriesCache(NinjaScriptBase ninjascript) : base(ninjascript, DEFAULT_CAPACITY, 0, false, 0) { }
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="ninjascript"/> cannot be null.</exception>
        public CalculateSeriesCache(NinjaScriptBase ninjascript, int capacity) : base(ninjascript, capacity, 0, false, 0) { }
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="ninjascript"/> cannot be null.</exception>
        public CalculateSeriesCache(NinjaScriptBase ninjascript, int capacity, int displacement) : base(ninjascript, capacity, displacement, false, 0) { }
        ...
        public CalculateSeriesCache(NinjaScriptBase ninjascript, int capacity, int displacement, int seriesIdx) : base(ninjascript, capacity, displacement, false, seriesIdx) { }
