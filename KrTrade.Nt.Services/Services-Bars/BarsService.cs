...
namespace KrTrade.Nt.Services
{
    public class BarsService : BaseNinjascriptService<BarsOptions>, IBarsService
    {
        ...
        // DataSeries
        private readonly IDataSeriesService _primaryDataSeries;
        private readonly DataSeriesCollection _dataSeries;
        //// Services
        ...
        public int RemovedCacheCapacity { get; protected set; }

        public IndexCache CurrentBar => _primaryDataSeries.CurrentBar;
        public TimeCache Time => _primaryDataSeries.Time;
        public SeriesCache Open => _primaryDataSeries.Open;
        public SeriesCache High => _primaryDataSeries.High;
        public SeriesCache Low => _primaryDataSeries.Low;
        public SeriesCache Close => _primaryDataSeries.Close;
        public SeriesCache Volume => _primaryDataSeries.Volume;
        public TicksCache Ticks => _primaryDataSeries.Ticks;

        public IDataSeriesService this[string name]
        {
            get
            {
                ...
                if (name == "0" ||  name == "PRIMARY" || name == "DEFAULT")
        ...
        public IDataSeriesService this[int idx]
        {
            get
            {
                if (idx == 0)
        ...
        public BarsService(NinjaScriptBase ninjascript, IPrintService printService, Action<BarsOptions> configureOptions) : base(ninjascript, printService, configureOptions,null)
        {
            ...
            _primaryDataSeries = new DataSeriesService(this);
