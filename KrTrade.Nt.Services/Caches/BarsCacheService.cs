...
namespace KrTrade.Nt.Services
{
    ...
    /// </summary>
    public class BarsCacheService : BaseCacheService<Bar>,
        IOnBarUpdateService,
        IOnBarClosedService,
        ...
        IOnLastBarRemovedService
    {
        ...
        public BarsCacheService(NinjaScriptBase ninjascript, BarsService barsService, int capacity) : base(ninjascript, barsService, capacity)
        {
        }
        ...
        public override bool IsBetterCandidateValue() => !CandidateValue.IsEqualsTo(LastValue);
