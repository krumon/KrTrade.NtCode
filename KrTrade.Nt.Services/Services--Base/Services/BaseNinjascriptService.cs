...
//        protected bool IsPrintServiceEnabled => _printService != null && IsLogEnable;
...
//            base(ninjascript, printService, info ?? new NinjascriptServiceInfo(), options ?? new NinjascriptServiceOptions()) 
//        {
